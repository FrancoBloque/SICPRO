...
namespace PresentacionWeb.Sitio.Vista.ValidacionProduccion
{
    public partial class wpr_listacom2 : System.Web.UI.Page
    {
        ...
        private void Datos()
        {
            ...
            var dataTable = _objConsumoModCom.VcoObtenerTablaPolizaNRI2(item, num_poliza.Text.ToUpper(), id_per.Value, id_spvs.Value, id_producto.Value, vigencia.Checked, fc_inivig.Date, fc_finvig.Date, fc_polizavencida.Date, porvencer.Checked);
